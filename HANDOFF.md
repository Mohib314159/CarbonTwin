"""
RUN ON THE DAY — one command, real Treefera data -> full audit + figures.
...
# ============================ CONFIG (edit on the day) =======================
DATA_PATH = "hackathon_demo_data/sentinel2/cube.zarr"  # their cube or CSV path
